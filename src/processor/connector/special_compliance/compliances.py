...
COMPLIANCES = [{
    ...
    "description":"Certain file types contain sensitive information and should not be checked into the git repositories. You need to move these files to a vault and reference them from your code. Prancer checks for the following file types to make sure they are not in the repo:<br>*.PFX or *.P12 - Personal Information Exchange Format<br>*.CER or *.CRT - Base64-encoded or DER-encoded binary X.509 Certificate<br>*.CRL - Certificate Revocation List<br>*.CSR - Certificate Signing Request<br>*.DER - DER-encoded binary X.509 Certificate<br>*.P7B or *.P7R or *.SPC - Cryptographic Message Syntax Standard<br>.Key – key files",
    "tags":[
        {
            "cloud":"git",
            "compliance":[],
