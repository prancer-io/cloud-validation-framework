...
def test_get_node_happy(monkeypatch):
    ...
    data = {
        ...
        'snapshotId': '1',
        'path': "/subscriptions/d34d6777-abcd-1234-8562-d8f5g6124789/resourceGroups/mno-nonprod-shared-cet-eastus2-networkWatcher/providers/"
    ...
    ret = get_node('abcd', 'devtest', 'd34d6777-abcd-1234-8562-d8f5g6124789', data, 'abc', 'azureStructure', [])
    assert True == isinstance(ret, dict)
    assert {'resources': [{'a': 'b'}], 'subscription_id': 'd34d6777-abcd-1234-8562-d8f5g6124789', 'resource_group': 'mno-nonprod-shared-cet-eastus2-networkWatcher'} == ret['json']
    # assert {'a': 'b'} == ret['json']
